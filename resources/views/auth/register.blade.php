            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            <label for="sim" class="col-md-4 col-form-label text-md-end">{{ __('Nomor Surat Izin Mengemudi (SIM)') }}</label>

                            <div class="col-md-6">
                                <input id="sim" type="sim" class="form-control @error('sim') is-invalid @enderror" name="sim" value="{{ old('sim') }}" required autocomplete="sim">
